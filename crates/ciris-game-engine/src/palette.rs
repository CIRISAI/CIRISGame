...
pub const STEWARD_SRGB: [Color; 4] = [
    STEWARD_SIENNA_SRGB,
    STEWARD_LAPIS_SRGB,
    STEWARD_VERDIGRIS_SRGB,
    STEWARD_KAOLIN_SRGB,
];
pub const STEWARD_LINEAR: [Color; 4] = [
    STEWARD_SIENNA_LINEAR,
    STEWARD_LAPIS_LINEAR,
    STEWARD_VERDIGRIS_LINEAR,
    STEWARD_KAOLIN_LINEAR,
];
