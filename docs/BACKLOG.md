...
### 4. Algorithm A sweep across N ∈ {3, 4, 5, 6, 7}
...
### 5. Lattice + materials (DESIGN_BRIEF §3)
...
### 10. Endgame animations (DESIGN_BRIEF §4.7)
...
Tier 2 (needs Tier 1, parallel internally)
